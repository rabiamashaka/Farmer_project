        ...
        <div class="overflow-x-auto mb-8">
            <table class="min-w-full border border-gray-200 text-sm text-left">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-2 text-center text-gray-500">No weather data found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full border border-gray-200 text-sm text-left">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-2 text-center text-gray-500">No market data found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
